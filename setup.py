...
#        'slapos.toolbox', # needed for libcloud, cloudmgr, disabled for now
      ...
      entry_points={
        'zc.buildout': [
          ...
          'check_ports_listening = slapos.recipe.check_ports_listening:Recipe',
          ...
          'mongo = slapos.recipe.mongo:Mongo', # mongodb recipe
          'mongos = slapos.recipe.mongo:Mongos', # mongos recipe
          'mongoszk =  slapos.recipe.mongo:MongoSzk', # mongos recipe + Zookeeper
          'mongozk = slapos.recipe.mongo:Mongozk',
          'mongo_confsrv = slapos.recipe.mongo:MongoConfsrv', # mongo config server
	  ...
	  'resilientlog.producer = slapos.recipe.resilientLog:Producer',
          'resilientlog.consumer = slapos.recipe.resilientLog:Consumer',
          'resilientlog.cli = slapos.recipe.resilientLog:Cli',
          ...
          'solrcloud.init = slapos.recipe.solrcloud:Initserver',
          'solrcloud.server = slapos.recipe.solrcloud:Server',
          'solrcloud.zk = slapos.recipe.solrcloud:Solrzk',
          'solrcloud.join = slapos.recipe.solrcloud:SolrJoin',
          ...
          'zookeeper = slapos.recipe.zookeeper:Recipe',
        ],
